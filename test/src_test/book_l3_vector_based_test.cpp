...
template <typename T>
class VectorBasedL3OrderBookTest : public ::testing::Test {};

using VectorBasedTypes = ::testing::Types<
    VectorBasedL3OrderBook<std::list<Order *>>,
    VectorBasedL3OrderBook<std::list<Order *>, BranchlessBinaryLevelSearcher>,
    VectorBasedL3OrderBook<std::list<Order *>, LinearLevelSearcher>,
    VectorBasedL3OrderBook<std::set<Order *, OrderCompare>>,
    VectorBasedL3OrderBook<std::set<Order *, OrderCompare>,
                           BranchlessBinaryLevelSearcher>,
    VectorBasedL3OrderBook<std::set<Order *, OrderCompare>, LinearLevelSearcher>,
    VectorBasedL3OrderBook<std::multiset<Order *, OrderCompare>>,
    VectorBasedL3OrderBook<std::multiset<Order *, OrderCompare>,
                           BranchlessBinaryLevelSearcher>,
    VectorBasedL3OrderBook<std::multiset<Order *, OrderCompare>, LinearLevelSearcher>>;

TYPED_TEST_SUITE(VectorBasedL3OrderBookTest, VectorBasedTypes);

TYPED_TEST(VectorBasedL3OrderBookTest, Basic) {
    TypeParam orderBook;
...
TYPED_TEST(VectorBasedL3OrderBookTest, Match) {
    TypeParam orderBook;
